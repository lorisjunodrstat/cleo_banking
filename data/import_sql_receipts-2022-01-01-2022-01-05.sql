-- Import reçus Loyverse — 2026-08-08 20:08:14 — user 6
SET NAMES utf8mb4;
SET @uid = 6;

-- 0. article_id NULL autorisé pour l'historique
...
-- Reçu 11-3883 (02/01/2022 18:20) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  restaurant_option_id, status
) VALUES (
  @uid, '2022-01-02 18:20:00', '2022-01-02 18:20:00', '11-3883', 'Import Loyverse', 'Vente',
  65.90, 0.00, 65.90, 1.61, 0.00, 65.90,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Ballaman Jennifer', '0766831700',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Ballaman Jennifer' LIMIT 1),
  1,
  'Fermé');
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Frais de livraison', 1.00, 1.00, 1.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Menu Duo', 1.00, 44.90, 44.90, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'California thon cuit mayonnaise', 1.00, 9.50, 9.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Maki foie gras confis d''oignons', 1.00, 10.50, 10.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3884 (02/01/2022 18:29) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 18:29:00', '2022-01-02 18:29:00', '11-3884', 'Import Loyverse', 'Vente',
  45.00, 0.00, 45.00, 1.10, 0.00, 45.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Monney Yves', '0794832949',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Monney Yves' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'california saumon avocat', 1.00, 8.50, 8.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'California thon avocat', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Maki crevette concombre', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki saumon avocat', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3885 (02/01/2022 18:41) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 18:41:00', '2022-01-02 18:41:00', '11-3885', 'Import Loyverse', 'Vente',
  44.00, 0.00, 44.00, 1.07, 0.00, 44.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Toth', '0774345585',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Toth' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Menu Végétarien Ii', 2.00, 22.00, 44.00, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 44.00, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Card' LIMIT 1;

-- Reçu 11-3886 (02/01/2022 18:58) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 18:58:00', '2022-01-02 18:58:00', '11-3886', 'Import Loyverse', 'Vente',
  42.50, 0.00, 42.50, 1.04, 0.00, 42.50,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Leonardi', '0799106249',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Leonardi' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California crevette spicy mangue', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'California thon spicy', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki poulet mangue poivron', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3887 (02/01/2022 19:09) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 19:09:00', '2022-01-02 19:09:00', '11-3887', 'Import Loyverse', 'Vente',
  50.00, 0.00, 50.00, 1.18, 0.00, 50.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Ana Andrade', '0762398271',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Ana Andrade' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California saumon concombre cheese', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki saumon', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Nigiri crevette', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Nigiri Saumon', 2.00, 7.50, 15.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3888 (02/01/2022 19:17) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 19:17:00', '2022-01-02 19:17:00', '11-3888', 'Import Loyverse', 'Vente',
  35.50, 0.00, 35.50, 0.87, 0.00, 35.50,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Sahitaj Adrian', '0796416795',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Sahitaj Adrian' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki Thon cuit mayonaise', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3889 (02/01/2022 19:42) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 19:42:00', '2022-01-02 19:42:00', '11-3889', 'Import Loyverse', 'Vente',
  42.50, 0.00, 42.50, 1.01, 0.00, 42.50,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Bertschy Julianne', '0798543367',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Bertschy Julianne' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California poulet mangue menthe', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'maki surimi mayonnaise', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Nigiri thon', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('Nigiri Saumon') LIMIT 1),
    NULL),
  'Nigiri Saumon', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 6-5120 (02/01/2022 20:07) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 20:07:00', '2022-01-02 20:07:00', '6-5120', 'Import Loyverse', 'Vente',
  59.90, 0.00, 59.90, 1.46, 0.00, 59.90,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Bussard Thierry', '0796687562',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Bussard Thierry' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipts (
  ...
  @uid, '2022-01-02 20:07:00', '2022-01-02 20:07:00', '6-5119', 'Import Loyverse', 'Vente',
  79.50, 0.00, 79.50, 1.94, 0.00, 79.50,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Fragniere Gaelle', '0795542407',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Fragniere Gaelle' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki crevette avocat', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California saumon avocat cheese', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'California thon avocat mangue', 1.00, 9.50, 9.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki banane nutela', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Maki mangue speculos', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 79.50, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Card' LIMIT 1;

-- Reçu 6-5121 (02/01/2022 20:42) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 20:42:00', '2022-01-02 20:42:00', '6-5121', 'Import Loyverse', 'Vente',
  126.50, 0.00, 126.50, 3.09, 0.00, 126.50,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'De Bernardini Maelle', '0796857641',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='De Bernardini Maelle' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Nigiri saumon grillé', 1.00, 7.50, 7.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Nigiri thon grillé', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California crevette avocat', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('Maki saumon avocat') LIMIT 1),
    NULL),
  'Maki saumon avocat', 2.00, 9.00, 18.00, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 126.50, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Cash' LIMIT 1;

-- Reçu 11-3890 (02/01/2022 21:01) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 21:01:00', '2022-01-02 21:01:00', '11-3890', 'Import Loyverse', 'Vente',
  62.40, 0.00, 62.40, 1.52, 0.00, 62.40,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Camille Amman', '0799037994',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Camille Amman' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3891 (02/01/2022 21:06) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 21:06:00', '2022-01-02 21:06:00', '11-3891', 'Import Loyverse', 'Vente',
  26.00, 0.00, 26.00, 0.63, 0.00, 26.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Porche Janique', '0793459156',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Porche Janique' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 6-5123 (02/01/2022 21:13) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 21:13:00', '2022-01-02 21:13:00', '6-5123', 'Import Loyverse', 'Vente',
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'California concombre avocat', 1.00, 7.50, 7.50, 2.50, 'Avocat';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 6-5122 (02/01/2022 21:13) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 21:13:00', '2022-01-02 21:13:00', '6-5122', 'Import Loyverse', 'Vente',
  59.90, 0.00, 59.90, 1.46, 0.00, 59.90,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Croset Sylvain', '0792568013',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Croset Sylvain' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3892 (02/01/2022 21:27) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-02 21:27:00', '2022-01-02 21:27:00', '11-3892', 'Import Loyverse', 'Vente',
  63.00, 0.00, 63.00, 1.54, 0.00, 63.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Marco Meyer', '0767477317',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Marco Meyer' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Menu Maki', 1.00, 20.00, 20.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Menu Best of', 1.00, 22.00, 22.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Menu Végétarien', 1.00, 20.00, 20.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3897 (04/01/2022 20:21) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 20:21:00', '2022-01-04 20:21:00', '11-3897', 'Import Loyverse', 'Vente',
  65.00, 0.00, 65.00, 1.59, 0.00, 65.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Stefano Pedrojetta', '0763429129',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Stefano Pedrojetta' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Whiteroll crevette concombre menthe', 1.00, 8.50, 8.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('California thon cuit mayonnaise') LIMIT 1),
    NULL),
  'California thon cuit mayonnaise', 2.00, 9.50, 19.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Nigiri saumon cheese', 1.00, 8.50, 8.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'Springroll Saumon cheese aneth', 1.00, 10.50, 10.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3896 (04/01/2022 20:21) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 20:21:00', '2022-01-04 20:21:00', '11-3896', 'Import Loyverse', 'Vente',
  31.00, 0.00, 31.00, 0.76, 0.00, 31.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Quinodoz Madison', '0791046441',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Quinodoz Madison' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3895 (04/01/2022 20:21) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 20:21:00', '2022-01-04 20:21:00', '11-3895', 'Import Loyverse', 'Vente',
  66.50, 0.00, 66.50, 1.62, 0.00, 66.50,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Léa Gaillet', '0798420148',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Léa Gaillet' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('Menu Maki') LIMIT 1),
    NULL),
  'Menu Maki', 2.00, 20.00, 40.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 11-3894 (04/01/2022 20:21) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 20:21:00', '2022-01-04 20:21:00', '11-3894', 'Import Loyverse', 'Vente',
  27.00, 0.00, 27.00, 0.66, 0.00, 27.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Python Kevin', '0797677007',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Python Kevin' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3893 (04/01/2022 20:21) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 20:21:00', '2022-01-04 20:21:00', '11-3893', 'Import Loyverse', 'Vente',
  31.00, 0.00, 31.00, 0.76, 0.00, 31.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Maya Meister', '0788371437',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Maya Meister' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Menu Kyoto', 1.00, 20.00, 20.00, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 31.00, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Eat.ch' LIMIT 1;

-- Reçu 11-3898 (04/01/2022 21:10) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-04 21:10:00', '2022-01-04 21:10:00', '11-3898', 'Import Loyverse', 'Vente',
  26.00, 0.00, 26.00, 0.63, 0.00, 26.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Lucia Paolicelli Damiano Rickenbach', '0788598173',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Lucia Paolicelli Damiano Rickenbach' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 6-5124 (05/01/2022 18:26) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 18:26:00', '2022-01-05 18:26:00', '6-5124', 'Import Loyverse', 'Vente',
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'A la piece', 1.00, 18.00, 18.00, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 18.00, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Cash' LIMIT 1;

-- Reçu 6-5125 (05/01/2022 19:56) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 19:56:00', '2022-01-05 19:56:00', '6-5125', 'Import Loyverse', 'Vente',
  91.50, 0.00, 91.50, 2.23, 0.00, 91.50,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Rossier Jocelyne', '0793894288',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Rossier Jocelyne' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki thon avocat', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('california saumon avocat') LIMIT 1),
    NULL),
  'california saumon avocat', 2.00, 8.50, 17.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 6-5126 (05/01/2022 19:57) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 19:57:00', '2022-01-05 19:57:00', '6-5126', 'Import Loyverse', 'Vente',
  54.50, 2.00, 52.50, 1.28, 0.00, 52.50,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Byrde Benjamin', '0792733978',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Byrde Benjamin' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    (SELECT id FROM pos_articles WHERE utilisateur_id=@uid AND LOWER(TRIM(nom_article))=LOWER('Maki Thon cuit mayonaise') LIMIT 1),
    NULL),
  'Maki Thon cuit mayonaise', 3.00, 9.00, 27.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Sashimi saumon 6 pieces', 1.00, 10.00, 10.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
-- Reçu 6-5127 (05/01/2022 19:58) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 19:58:00', '2022-01-05 19:58:00', '6-5127', 'Import Loyverse', 'Vente',
  28.50, 0.00, 28.50, 0.70, 0.00, 28.50,
  'Caisse principal 3', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Christophe Khuu (/Sari Amstutz)', '0798307821',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Christophe Khuu (/Sari Amstutz)' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3900 (05/01/2022 20:46) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 20:46:00', '2022-01-05 20:46:00', '11-3900', 'Import Loyverse', 'Vente',
  60.90, 0.00, 60.90, 1.49, 0.00, 60.90,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Carrell mariella', '0787103462',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Carrell mariella' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
-- Reçu 11-3899 (05/01/2022 20:46) — Vente — À emporter
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 20:46:00', '2022-01-05 20:46:00', '11-3899', 'Import Loyverse', 'Vente',
  55.00, 0.00, 55.00, 1.34, 0.00, 55.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Schwaller Marco', '0792816742',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Schwaller Marco' LIMIT 1),
  4,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Springroll poulet mangue poivron', 1.00, 9.00, 9.00, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
  COALESCE(
    ...
    NULL),
  'California Thon cuit avocat', 1.00, 9.50, 9.50, 2.50, '';
INSERT INTO pos_receipt_items (
  receipt_id, article_id, nom_article, quantite,
  prix_unitaire, total_ligne, taux_taxe_applique, commentaire
) SELECT @receipt_id,
...
INSERT INTO pos_receipt_items (
  ...
  COALESCE(
    ...
    NULL),
  'Maki Thon cuit mayo avocat', 1.00, 9.50, 9.50, 2.50, '';
INSERT INTO pos_payments (receipt_id, mode_paiement_id, montant, est_remboursement)
SELECT @receipt_id, mp.id, 55.00, 0
FROM pos_modes_paiement mp
WHERE mp.utilisateur_id=@uid AND mp.nom='Card' LIMIT 1;

-- Reçu 11-3901 (05/01/2022 20:47) — Vente — Livré
INSERT INTO pos_receipts (
  utilisateur_id, date, cloture_at, recu_numero, nom_ticket, receipt_type,
  ventes_brutes, reduction, ventes_nettes, taxes, tips, total_collecte,
  pdv, magasin, nom_du_caissier, nom_du_client, numero_client, id_client,
  ...
  @uid, '2022-01-05 20:47:00', '2022-01-05 20:47:00', '11-3901', 'Import Loyverse', 'Vente',
  23.00, 10.00, 13.00, 0.32, 0.00, 13.00,
  'SamsungA40', 'Esprit Sushi Fribourg', 'Propriétaire',
  'Plattet', '0794227066',
  (SELECT id FROM pos_clients WHERE utilisateur_id=@uid AND nom_client='Plattet' LIMIT 1),
  1,
  'Fermé');
SET @receipt_id = LAST_INSERT_ID();
INSERT INTO pos_receipt_items (
...
JOIN pos_articles a ON a.utilisateur_id=@uid AND LOWER(TRIM(a.nom_article))=LOWER(TRIM(ri.nom_article))
SET ri.article_id=a.id WHERE ri.article_id IS NULL;

-- 5. VÉRIFICATION
SELECT COUNT(*) AS recus FROM pos_receipts WHERE nom_ticket='Import Loyverse';
SELECT COUNT(*) AS items_sans_article FROM pos_receipt_items ri JOIN pos_receipts r ON r.id=ri.receipt_id WHERE r.nom_ticket='Import Loyverse' AND ri.article_id IS NULL;
